...
# Function that creates box plots by categories
def plot_boxplot(data, category_col, continuous_col):
    ...
    sns.boxplot(data=data, x=category_col, y=continuous_col, palette=colors)
    plt.title(f'Box Plot of {continuous_col} by {category_col}', fontsize=14)
    plt.xlabel(category_col, fontsize=12)
    plt.ylabel(continuous_col, fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.show()


plot_boxplot(data, '6th Stage', 'Tumor Size')
plot_boxplot(data, 'T Stage ', 'Tumor Size')
plot_boxplot(data, 'N Stage', 'Tumor Size')
plot_boxplot(data, 'A Stage', 'Tumor Size')
plot_boxplot(data, '6th Stage', 'Survival Months')
plot_boxplot(data, '6th Stage', 'Age')
plot_boxplot(data, 'Progesterone Status', 'Tumor Size')
plot_boxplot(data, 'Estrogen Status', 'Tumor Size')
